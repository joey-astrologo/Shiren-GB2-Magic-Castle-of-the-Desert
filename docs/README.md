...
| [ROM_BANK_MAP.md](ROM_BANK_MAP.md) | ROM, WRAM, SRAM, and transient menu-state ownership | **Before** placing or moving ROM, font, menu, navigation, name, spell, graphics, or save data |
