...
This page documents the earlier standalone prose editor. The [subject workbenches](../workbench/README.md) include the same scenes and all other extracted text, with a separate shared draft.
...
credit appears in the editor guide and the bundled [font license](font-license.txt).
