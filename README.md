...
| Automated verification | **711 suite tests passed — 2026-09-11** | Zero failures, errors, or skips; 41 additional checks on the final ROMs, nine validators, four browser checks, and reproducible ROM/IPS builds passed. Includes all 20 debug-menu regressions; [final results and remaining playtests](docs/DEBUG-ROOM.md#final-validation-results) |
