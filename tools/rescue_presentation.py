#!/usr/bin/env python3
"""Install English presentation for native 64-symbol password families.
...
validator sees the input buffer. The separate Clear Campaign and True Wanderer
certificates map only their six-byte display copies; those historical mail-in
authentication codes have no in-game input route.
"""
...
CLEAR_CAMPAIGN_HOOK_BANK = 0
CLEAR_CAMPAIGN_PASSWORD_HOOK_ADDRESS = 0x3573
CLEAR_CAMPAIGN_PASSWORD_HOOK_EXPECTED = bytes.fromhex("3E11213B7ECDAC09")
CLEAR_CAMPAIGN_PASSWORD_WRAPPER = 0x42A2
TRUE_WANDERER_PASSWORD_HOOK_ADDRESS = 0x355F
TRUE_WANDERER_PASSWORD_HOOK_EXPECTED = bytes.fromhex("3E1121017ECDAC09")
TRUE_WANDERER_PASSWORD_WRAPPER = 0x42AC
...

""")
...
def owned_ranges():
    hooks = tuple(
        ...
        for bank, address, expected in (
            ...
            (
                CLEAR_CAMPAIGN_HOOK_BANK,
                CLEAR_CAMPAIGN_PASSWORD_HOOK_ADDRESS,
                CLEAR_CAMPAIGN_PASSWORD_HOOK_EXPECTED,
            ),
            (
                CLEAR_CAMPAIGN_HOOK_BANK,
                TRUE_WANDERER_PASSWORD_HOOK_ADDRESS,
                TRUE_WANDERER_PASSWORD_HOOK_EXPECTED,
            ),
        )
    )
...
def install(rom, verify_original=True, checksums=True):
    ...
    for bank, address, expected, target in (
        ...
        (
            ...
            CLEAR_CAMPAIGN_PASSWORD_HOOK_ADDRESS,
            CLEAR_CAMPAIGN_PASSWORD_HOOK_EXPECTED,
            CLEAR_CAMPAIGN_PASSWORD_WRAPPER,
        ),
        (
            CLEAR_CAMPAIGN_HOOK_BANK,
            TRUE_WANDERER_PASSWORD_HOOK_ADDRESS,
            TRUE_WANDERER_PASSWORD_HOOK_EXPECTED,
            TRUE_WANDERER_PASSWORD_WRAPPER,
        ),
    ):
